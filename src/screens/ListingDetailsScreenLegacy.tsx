...
export const ListingDetailsScreenLegacy = ({ navigation, route }: Props) => {
  ...
  const handleToggleSaved = useCallback(async () => {
    try {
      const nextSaved = await toggleSavedListing(itemId);
      setIsSaved(nextSaved);

      Alert.alert(
        nextSaved ? 'Saved' : 'Removed',
        nextSaved ? 'Listing added to your saved items.' : 'Listing removed from your saved items.',
      );
    } catch {
      ...
      <View style={styles.card}>
        ...
        <View style={styles.actionRow}>
          ...
          <Pressable style={styles.secondaryButton} onPress={handleToggleSaved}>
            <Text style={styles.secondaryButtonText}>{isSaved ? 'Remove Saved' : 'Save Listing'}</Text>
          </Pressable>
        </View>
      </View>
    </ScrollView>
